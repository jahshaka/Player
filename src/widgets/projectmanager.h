...
public:
    ...
    void importProjectFromDownload(const QString &guid);
    void importProjectFromDownloadSilently(const QString &str, const QString &guid);
    void importProjectFromStore(const QString &guid);

protected slots:
    void openSampleProject(QListWidgetItem*);
    void newProject();
    void importProjectFromFile(const QString& file = QString(), bool silent = false, const QString &preserveGuid = QString());
    void importProjectFromFileVR(const QString& file = QString());
